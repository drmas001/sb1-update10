...
import { UserPlus, Calendar, User, Users, Activity, FileText, Clock } from 'lucide-react';
...
const NewPatientAdmission: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!patientData.mrn || !patientData.patient_name || !patientData.age || !patientData.gender || !patientData.admission_date || !patientData.admission_time || !patientData.shift_type || !patientData.assigned_doctor || !patientData.specialty || !patientData.diagnosis) {
      ...
      const patientInsertData = {
        ...patientData,
        age: parseInt(patientData.age.toString(), 10),
